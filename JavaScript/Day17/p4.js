...
let result={}
salesData.forEach((eachObj)=>{
    let cityName=eachObj.city
    let currSales=eachObj.sales
    if(currSales in result){
        if(currSales>result[cityName]){
            result[cityName]=currSales
        }
